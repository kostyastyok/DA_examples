...
# Оценка пользовательской активности. Прогнозирование оттока.
...
Из интересного: *Пример построения предективной модели оттока (логистическая регрессия, случайный лес)*. 
